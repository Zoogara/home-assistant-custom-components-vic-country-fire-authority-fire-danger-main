"""Config flow to configure the VIC Country Fire Authority Fire Danger integration."""
...
class VicCfaFireDangerFlowHandler(
    config_entries.ConfigFlow, domain=DOMAIN
):
    """Handle a VIC Country fire Authority Fire Danger config flow."""
