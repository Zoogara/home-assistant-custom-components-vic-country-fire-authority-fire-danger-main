# VIC Country Fire Authority Fire Danger.
import logging
...
from .coordinator import (
    VicCfaFireDangerExtendedFeedCoordinator,
    VicCfaFireDangerFeedCoordinator,
    VicCfaFireDangerStandardFeedCoordinator,
)
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    """Set up the VIC Country Fire Authority Fire Danger component."""
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up the VIC Country Fire Authority Fire Danger component as config entry."""
    hass.data.setdefault(DOMAIN, {})
    # Create feed coordinator for all platforms.
    data_feed_coordinator: VicCfaFireDangerFeedCoordinator
    data_feed = entry.data.get(CONF_DATA_FEED, DEFAULT_DATA_FEED)
    if data_feed == "standard":
        data_feed_coordinator = VicCfaFireDangerStandardFeedCoordinator(hass, entry)
    elif data_feed == "extended":
        data_feed_coordinator = VicCfaFireDangerExtendedFeedCoordinator(hass, entry)
    else:
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Unload an VIC Country Fire Autority Fire Danger component config entry."""
