# VIC Country fire Authority Fire Danger - Data Coordinators.
import logging
...
class VicCfaFireDangerFeedCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    """Feed Entity Manager for CIC Country Fire Authority Fire Danger feed."""
...
class VicCfaFireDangerStandardFeedCoordinator(VicCfaFireDangerFeedCoordinator):
    """Feed Entity Manager for VIC Country Fire Authority Fire Danger standard feed."""
    ...
    def _attribute_in_structure(obj, keys):
        ...
        if key in obj:
            return (
                VicCfaFireDangerStandardFeedCoordinator._attribute_in_structure(
                    obj[key], keys
                )
                if keys
                else obj[key]
...
class VicCfaFireDangerExtendedFeedCoordinator(VicCfaFireDangerFeedCoordinator):
